...
abstract class KGPBaseTest {
    ...
    // Currently IDEA does not support JUnit meta-annotations and
    // does not mark method with them as test methods. This dummy test exists,
    // so it will be possible to run test class that only contains tests with
    // meta annotations
    // https://youtrack.jetbrains.com/issue/IDEA-265284
    @DisplayName("Ignored (IDEA Compatibility)")
    @Test
    fun dummyTest() = Unit
